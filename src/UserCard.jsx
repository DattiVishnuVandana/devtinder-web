...
//   try{
//  const res=await axios.post(BASE_URL+"/connectionReq/send/"+status+"/"+userId,{},{withCredentials:true})  
...
//       <button className="btn btn-primary" onClick={()=>handleSendReq("ignored",user?._id)}>ignore</button>
//       <button className="btn btn-secondary" onClick={()=>handleSendReq("interested",user?._id)}>interested</button>
//     </div>
//   </div>
// </div>
//     </div>
